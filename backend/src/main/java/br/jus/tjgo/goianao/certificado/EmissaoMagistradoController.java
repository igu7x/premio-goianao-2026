...
/** Meus certificados, na visao do magistrado (005). */
@RestController
@RequestMapping("/api/magistrado/certificados")
@PreAuthorize("hasRole('MAGISTRADO')")
public class EmissaoMagistradoController {

    private final EmissaoMagistradoService servico;

    public EmissaoMagistradoController(EmissaoMagistradoService servico) {
